...
/**
 * Main class, containing the interface for PngEncoder. PngEncoder is a really
 * fast encoder for PNG images in Java.
 */
public class PngEncoder {
	/**
	 * Compression level 9 is the default. It produces images with a size comparable
	 * to ImageIO.
	 */
	 ...
	 *            input image (must be between -1 and 9 inclusive)
	 * @return a new PngEncoder
	 */
	 ...
	 *
	 * @param multiThreadedCompressionEnabled
	 *            when {@code true}, multithreaded compression will be used
	 * @return a new PngEncoder
	 */
	 ...
	 *
	 * @param srgbRenderingIntent
	 *            the rendering intent that should be used when displaying the image
	 * @return a new PngEncoder
	 */
	...
	/**
	 * @param enablePredictor
	 *            true if predictor encoding should be used.
	 * @return a new PngEncoder
	 */
	 ...
	 * 
	 * @param outputStream
	 *            destination of the encoded data
	 ...
	 * 
	 * @param filePath
	 *            destination file where the encoded data will be written
	 * @throws NullPointerException
	 *             if the image has not been set.
